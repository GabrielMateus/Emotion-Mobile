  ...
  const Pontuacao = () => {
    ...
    if (pontuacao < 15) {
      ...
      setResp({
        ...
        text: ` "Prefiro uma abordagem mais calma" O profissional estável tende a ser gentil e simpático mas tem dificuldade de dizer não. São pessoas que lidam melhor com as rotinas e padrões.`,
      });
    } else {
      setResp({
